...
const InstitutionDetailsPage = () => {
        ...
        if (instResponse.success) {
          ...
          if (instResponse.institution.nftTokenId) {
            try {
              ...
              console.error(
                "Failed to fetch institution NFT metadata:",
                nftErr
              );
            }
          }
  ...
  const handleCompleteStudies = async (applicationId) => {
    ...
    try {
      ...
      setError(
        err.response?.data?.message || "Failed to mark studies as completed"
      );
    } finally {
      setProcessing(false);
    }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {applications
          ...
          .map((app) => (
            <div
              ...
              className="mb-4 last:mb-0 border border-green-100 bg-green-50 rounded-md p-4"
            >
              <div className="flex justify-between items-center mb-3">
                ...
                <div className="text-sm text-green-600">
                  {app.verificationData?.verifiedAt
                    ? new Date(
                        app.verificationData.verifiedAt
                      ).toLocaleDateString()
                    : "Recently approved"}
              ...
              <p className="text-sm text-green-700 mb-4">
                Your application to {institution.name} has been approved. You
                can now confirm your admission.
              </p>

              <div className="bg-white p-3 rounded-md border border-green-200 mb-4">
                <p className="text-sm font-medium text-gray-700">
                  Program: {app.programDetails?.program || "Not specified"}
                </p>
                {app.programDetails?.department && (
                  <p className="text-sm text-gray-600">
                    Department: {app.programDetails.department}
                  </p>
                )}
              ...
              <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 text-sm text-yellow-700 mb-4">
                <p className="flex items-center">
                  ...
                  <strong>Important:</strong> Confirming this admission will
                  withdraw all your other pending applications.
                </p>
              </div>
        ...
        {applications
          ...
          .map((app) => (
            <div
              key={app.applicationId}
              className="mb-4 last:mb-0 border border-blue-100 bg-blue-50 rounded-md p-4"
            >
              <div className="flex justify-between items-center mb-3">
                <div className="flex items-center">
